            ...
            [
                ...
                'inputSchema' => [
                    ...
                    'properties' => [
                        ...
                        'codes' => ['type' => 'array', 'items' => ['type' => 'string'], 'description' => '规则子集（缺省全部）：php_syntax/controller/permission/migration/residue/version/web_page/async_blocking/fqcn_dup/superglobal/dead_code/cross_copy/dto_contract'],
